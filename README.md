...
```
cd existing_repo
git remote add origin https://gitlab.zapouh.fr/intra-services/library/libs-async-coms.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.zapouh.fr/intra-services/library/libs-async-coms/-/settings/integrations)
